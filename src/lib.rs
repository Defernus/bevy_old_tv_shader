//! This example shows how to create a custom render pass that runs after the
//! main pass and reads the texture generated by the main pass.
//!
//! The example shader is a very simple implementation of chromatic aberration.
//! To adapt this example for 2D, replace all instances of 3D structures (such
//! as `Core3D`, etc.) with their corresponding 2D counterparts.
//!
//! This is a fairly low-level example and assumes some familiarity with
